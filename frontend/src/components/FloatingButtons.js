  ...
  return (
    <div className="fixed right-4 bottom-6 z-40 flex flex-col gap-3">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="group relative w-12 h-12 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg shadow-green-500/25 hover:scale-110 transition-transform"
        aria-label="WhatsApp"
      >
